...
class Location(Model):
    ...
    def location_lat(self) -> str:
        """Gets the location_lat of this Location.

        Szerokosc geograficzna  # noqa: E501

        :return: The location_lat of this Location.
        :rtype: str
        """
    ...
    def location_lat(self, location_lat: str):
        """Sets the location_lat of this Location.

        Szerokosc geograficzna  # noqa: E501

        :param location_lat: The location_lat of this Location.
        :type location_lat: str
        """
    ...
    def location_long(self) -> str:
        """Gets the location_long of this Location.

        Dlugosc geograficzna  # noqa: E501

        :return: The location_long of this Location.
        :rtype: str
        """
    ...
    def location_long(self, location_long: str):
        """Sets the location_long of this Location.

        Dlugosc geograficzna  # noqa: E501

        :param location_long: The location_long of this Location.
        :type location_long: str
        """
    ...
    def location_reward(self) -> str:
        """Gets the location_reward of this Location.

        Nagroda za pozostawienie auta tutaj  # noqa: E501

        :return: The location_reward of this Location.
        :rtype: str
        """
    ...
    def location_reward(self, location_reward: str):
        """Sets the location_reward of this Location.

        Nagroda za pozostawienie auta tutaj  # noqa: E501

        :param location_reward: The location_reward of this Location.
        :type location_reward: str
        """
