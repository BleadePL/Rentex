...
class Car(db.Model):
    ...
    regCountryCode = db.Column(db.String(30), unique=True, nullable=False)
    regNumber = db.Column(db.String(255), unique=True, nullable=False)
    modelName = db.Column(db.String(255), unique=True, nullable=False)
    seats = db.Column(db.DateTime(), unique=True, nullable=False)
    lastUsed = db.Column(db.String(20), unique=True, nullable=False)
    chargeLevel = db.Column(db.String(20), unique=True, nullable=False)
    mileage = db.Column(db.String(64), unique=True, nullable=False)
    currentLocationLat = db.Column(db.String(50), unique=True, nullable=False)
    currentLocationLong = db.Column(db.String(10), unique=True, nullable=False)
    lastUpdateTime = db.Column(db.Integer(), unique=True, nullable=False)
    status = db.Column(db.String(10), unique=True, nullable=False)
    activationCost = db.Column(db.String(120), unique=True, nullable=False)
    kmCost = db.Column(db.String(120), unique=True, nullable=False)
    timeCost = db.Column(db.String(120), unique=True, nullable=False)
    esimNumber = db.Column(db.String(120), unique=True, nullable=False)
    esimImei = db.Column(db.String(120), unique=True, nullable=False)
...
class Rental(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    rentalStart = db.Column(db.String(20), unique=True, nullable=False)
    rentalEnd = db.Column(db.String(30), unique=True, nullable=False)
    mileage = db.Column(db.String(30), unique=True, nullable=False)
    totalCost = db.Column(db.String(255), unique=True, nullable=False)
    ended = db.Column(db.String(255), unique=True, nullable=False)
...
class Reservation(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    reservationStart = db.Column(db.String(20), unique=True, nullable=False)
    reservationEnd = db.Column(db.String(30), unique=True, nullable=False)
...
class Service(db.Model):
    ...
    dateEnd = db.Column(db.String(30), unique=True, nullable=False)
...
class Location(db.Model):
    ...
    locationAddress = db.Column(db.String(30), unique=True, nullable=False)
    leaveReward = db.Column(db.String(30), unique=True, nullable=False)
    locationLat = db.Column(db.String(255), unique=True, nullable=False)
    locationLong = db.Column(db.String(255), unique=True, nullable=False)
    services = db.relationship('Service', backref='location', lazy=True)

class CreditCard(db.Model):
    __tablename__ = COLLECTION_CREDIT_CARDS
    id = db.Column(db.Integer, primary_key=True)
    cardNumber = db.Column(db.String(20), unique=True, nullable=False)
    expirationDate = db.Column(db.String(30), unique=True, nullable=False)
    cardHolderName = db.Column(db.String(30), unique=True, nullable=False)
    cardHolderAddress = db.Column(db.String(255), unique=True, nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False)
