...
class Car:
    ...
    def __init__(self, car_id: int = None, brand: str = None, reg_number: str = None, model: str = None,
                 ...
                 vin: str = None, currentReservation: Reservation = None):  # noqa: E501
...
class User:
    ...
    def __init__(self, userId: str = None, login: str = None, email: str = None, name: str = None, surname: str = None,
                 ...
                 current_rental: Rental = None, cards: list = None):  # noqa: E501
        ...
        self.pesel = pesel
        self.driverLicence_number = driver_licence_number
        self.driverLicence_expiration_date = driver_licence_expiration_date
        self.lastRental = last_rental
        self.currentRental = current_rental
        self.lastReservation = last_reservation
        self.role = role
        self.cards = cards
...
class Location:
    ...
    def __init__(self, location_id: str = None, name: str = None, location_lat: str = None, location_long: str = None,
        ...
        self.locationReward = location_reward
